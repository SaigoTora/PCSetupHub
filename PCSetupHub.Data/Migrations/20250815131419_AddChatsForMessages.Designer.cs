...
namespace PCSetupHub.Data.Migrations
{
    ...
    [Migration("20250815131419_AddChatsForMessages")]
    partial class AddChatsForMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PCSetupHub.Data.Models.Relationships.UserChats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PCSetupHub.Data.Models.Users.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PCSetupHub.Data.Models.Relationships.UserChats", b =>
                {
                    b.HasOne("PCSetupHub.Data.Models.Users.Chat", "Chat")
                        .WithMany("UserChats")
