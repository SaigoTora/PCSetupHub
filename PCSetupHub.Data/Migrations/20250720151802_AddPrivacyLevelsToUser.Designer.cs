...
namespace PCSetupHub.Data.Migrations
{
    ...
    [Migration("20250720151802_AddPrivacyLevelsToUser")]
    partial class AddPrivacyLevelsToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PCSetupHub.Data.Models.Users.Friendship", b =>
                {
                    ...
                    b.HasOne("PCSetupHub.Data.Models.Users.FriendshipStatus", "FriendshipStatus")
            ...
            modelBuilder.Entity("PCSetupHub.Data.Models.Users.User", b =>
                {
                    ...
                    b.HasOne("PCSetupHub.Data.Models.Hardware.PcConfiguration", "PcConfiguration")
                        .WithOne("User")
                        .HasForeignKey("PCSetupHub.Data.Models.Users.User", "PcConfigurationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PCSetupHub.Data.Models.Users.PrivacyLevel", b =>
                {
                    b.Navigation("FollowersAccessUsers");

                    b.Navigation("FollowingsAccessUsers");

                    b.Navigation("MessagesAccessUsers");

                    b.Navigation("PcConfigAccessUsers");
                });
